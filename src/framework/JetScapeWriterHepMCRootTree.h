...
#ifndef JETSCAPEWRITERHEPMCROOTTREE_H
#define JETSCAPEWRITERHEPMCROOTTREE_H
...
class JetScapeWriterHepMCRootTree : public JetScapeWriter, public HepMC3::WriterRootTree {
