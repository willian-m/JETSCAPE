...
JetScapeWriterHepMCRootTree::~JetScapeWriterHepMCRootTree() {
  if (GetActive())
    Close();
}

void JetScapeWriterHepMCRootTree::WriteHeaderToFile() {
...
void JetScapeWriterHepMCRootTree::WriteEvent() {
  VERBOSE(1) << "Run JetScapeWriterHepMCRootTree: Write event # " << GetCurrentEvent();
...
void JetScapeWriterHepMCRootTree::Write(weak_ptr<PartonShower> ps) {
...
void JetScapeWriterHepMCRootTree::Write(weak_ptr<Hadron> h) {
  auto hadron = h.lock();
  if (!hadron)
    return;
...
void JetScapeWriterHepMCRootTree::Init() {
  if (GetActive()) {
...
void JetScapeWriterHepMCRootTree::Exec() {
  // Nothing to do
}
